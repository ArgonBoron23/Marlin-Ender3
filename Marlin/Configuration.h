...
#define CUSTOM_MACHINE_NAME "Arjun Bhatia - Ender 3"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  20.93,  20.93 }
    #define DEFAULT_Ki_LIST {   2.04,   2.04 }
    #define DEFAULT_Kd_LIST { 53.58, 53.58 }
  #else
    #define DEFAULT_Kp  20.93
    #define DEFAULT_Ki   2.04
    #define DEFAULT_Kd  53.58
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 710 }
